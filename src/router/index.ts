...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: "customers/:customerId", component: () => import("@/views/apps/toolshop/Customer/CustomerDetail.vue"), props: true },            { path: "inventory", component: () => import("@/views/apps/toolshop/Inventory.vue") },
