...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: "customers", component: () => import("@/views/apps/toolshop/Customer/Customers.vue") },
            { path: "customers/:customerId", component: () => import("@/views/apps/toolshop/Customer/CustomerDetail.vue"), props: true },            
            { path: "inventory", component: () => import("@/views/apps/toolshop/Inventory/Inventory.vue") },
            { path: "inventory/:inventoryId", component: () => import("@/views/apps/toolshop/Inventory/InventoryDetail.vue"), props: true },            
